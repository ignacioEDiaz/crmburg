...
export default function FavoritesView() {
  ...
  return (
    <div className="relative w-full max-w-7xl mx-auto min-h-screen bg-[#161616] font-body-lg text-white pb-28 pt-20 px-4 md:px-8 shadow-2xl">
      <div className="flex flex-col gap-lg">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h2 className="font-headline-xl text-headline-xl text-white">Tus Platos Favoritos</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-lg">
          {favProducts.map((p) => (
            <div
              ...
              className="bg-[#242426] border border-white/10 rounded-3xl p-lg flex flex-col justify-between cursor-pointer hover:bg-[#2c2c2e] transition-all shadow-md group"
            >
              ...
              <div className="flex flex-col gap-xs pt-3 border-t border-white/10">
                ...
                <div className="flex justify-between items-center mt-3">
                  <span className="font-price-display text-primary font-black text-xl">$ {Number(p.price).toFixed(2)}</span>
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      addToCart(p, 1);
                    }}
                    className="w-9 h-9 rounded-full bg-primary flex items-center justify-center text-white shadow-md hover:scale-110 transition-transform"
                  >

        ...
        <div className="relative z-10 flex flex-col gap-6">
                ...
                {['Sencilla', 'Doble', 'Triple'].map((s) => (
                  <button
                    ...
                    className={`py-2.5 rounded-2xl text-xs font-bold border transition-all ${
                      size === s
                        ? 'bg-gradient-to-r from-amber-500 to-orange-500 text-black border-transparent font-black shadow-[0_4px_15px_rgba(245,158,11,0.4)] scale-[1.02]'
          ...
          <div className="flex items-center justify-between border-t border-white/10 pt-5 mt-1">
            ...
            <button
              ...
              className="flex-1 ml-4 py-3.5 px-6 rounded-full bg-gradient-to-r from-amber-500 via-orange-500 to-amber-500 hover:from-amber-400 hover:to-orange-400 text-black font-black text-xs uppercase tracking-wider shadow-[0_4px_20px_rgba(245,158,11,0.45)] hover:scale-105 active:scale-95 transition-all"
            >

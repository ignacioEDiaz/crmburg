      ...
      <div className="flex flex-col gap-lg">
        ...
        <div>
          <div className="flex items-center gap-2">
            <h2 className="font-headline-xl text-headline-xl text-white">Tus Pedidos en Curso</h2>
        ...
        {orders.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-lg">
            {orders.map((order) => (
              <div key={order.id} className="bg-[#242426] rounded-3xl p-lg flex flex-col justify-between relative border border-white/10 shadow-lg">
                <div>
                  <div className="flex justify-between items-start border-b border-white/10 pb-sm mb-md">
                    <div>
                      <span className="font-mono text-primary font-bold text-lg">{order.code}</span>
                ...
                <div className="flex justify-between items-center border-t border-white/10 pt-md mt-sm">
                  ...
                  <span className="font-price-display text-price-display text-primary font-black text-xl">$ {Number(order.total).toFixed(2)}</span>
                </div>
              </div>
            ))}
          </div>
